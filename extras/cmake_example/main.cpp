...
int main(int argc, char* argv[]) {
  ...
  cout << "Message\n";
  cout << "\tJson: " << message.toJson() << '\n';
  cout << "\tVerified: " << boolalpha << message.verify() << '\n';
  cout << '\n';
  ...
  cout << "\tPassphrase: " << passphrase << '\n';
  cout << "\tNetwork Version: 0x" << hex << static_cast<uint16_t>(networkVersion) << '\n';
  ...
  cout << "Valid Address\n";
  cout << "\tAddress: " << address.toString() << '\n';
  cout << "\t Valid Address: " << boolalpha << isValidAddress << '\n';
  cout << '\n';
  ...
  cout << "\tPassphrase: " << passphrase << '\n';
  cout << "\tWIF Byte: 0x" << hex << static_cast<uint16_t>(wifByte) << '\n';
  cout << "\tWIF: " << wif.toString() << endl;
